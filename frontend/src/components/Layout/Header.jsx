  ...
  return (
    <>
        ...
        <div className="hidden 800px:h-[50px] 800px:my-[20px] 800px:flex items-center justify-between">
          ...
          <div className="w-[50%] relative">
            <input
              ...
              className="h-[40px] w-full px-2 border-[#4ab4c2] border-[2px] rounded-md"
            />
            <AiOutlineSearch
              size={30}
      ...
      <div
        ...
        } transition hidden 800px:flex items-center justify-between w-full bg-[#21c0c8] h-[70px]`}
      >
        <div
      ...
      >
        <div className="w-full flex items-center justify-between">
          ...
          <div>
            <Link to="/">
            <h1 style={{ color: '#142337', fontSize: '34px', fontWeight: 'bold' }}>vaymp</h1>
            </Link>
          </div>
          <div>
            <div
              ...
              <div className="flex w-full justify-center">
                {isAuthenticated ? (
                  <div>
                    <Link to="/profile">
                      <img
                        src={`${user.avatar?.url}`}
                        alt=""
                        className="w-[60px] h-[60px] rounded-full border-[3px] border-[#47986d]"
                      />
                    </Link>
                  </div>
                ) : (
                  <>
                    <Link
                      to="/login"
                      className="text-[18px] pr-[10px] text-[#35a56fb7]"
                    >
                      Login /
                    </Link>
                    <Link
                      to="/sign-up"
                      className="text-[18px] text-[#26a254]"
                    >
                      Sign up
                    </Link>
                  </>
